...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ShopApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default http://demo-ocapi.demandware.net/s/-/dw/shop/20.8
     */
    this.basePath = 'http://demo-ocapi.demandware.net/s/-/dw/shop/20.8'.replace(/\/+$/, '');
  ...
  /**
    ...
    */
    exports.hostSettings = function() {
        return [
            {
              'url': "//demo-ocapi.demandware.net/s/-/dw/shop/20.8",
