...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ShopApi.ProductRecommendationsResult = factory(root.ShopApi.ApiClient, root.ShopApi.Product);
  }
   ...
   * @module model/ProductRecommendationsResult
   * @version 20.8
   */
   ...
   * @alias module:model/ProductRecommendationsResult
   * @class
   */
   ...
   * @param {module:model/ProductRecommendationsResult} obj Optional instance to populate.
   * @return {module:model/ProductRecommendationsResult} The populated <code>ProductRecommendationsResult</code> instance.
   */
