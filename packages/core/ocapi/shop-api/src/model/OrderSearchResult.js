...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrderSearchHit', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrderSearchHit'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.ShopApi) {
      root.ShopApi = {};
    }
    root.ShopApi.OrderSearchResult = factory(root.ShopApi.ApiClient, root.ShopApi.OrderSearchHit, root.ShopApi.ResultPage, root.ShopApi.Sort);
  }
}(this, function(ApiClient, OrderSearchHit, ResultPage, Sort) {
  'use strict';
