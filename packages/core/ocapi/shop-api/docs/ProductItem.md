...
**cOSP** | **Number** |  | [optional] 
**cBonusProductLineItemUUID** | **String** | This represents the UUID of the product line item that holds the qualifying product. | [optional] 
...
**cLoyaltyPointsNumber** | **Number** |  | [optional] 
**cPoints** | **Number** |  | [optional] 
**cPreOrderUUID** | **String** | this custom attribute captures the original product line item uuid before it is part of an placed order | [optional] 
