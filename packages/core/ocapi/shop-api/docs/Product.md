...
**bundledProducts** | [**[BundledProduct]**](BundledProduct.md) | The array of all bundled products of this product. | [optional] 
...
**validTo** | **Date** | The time when product is valid to. | [optional] 
