...
(function(root, factory) {
  ...
  describe('OrdersApi', function() {
    ...
    describe('putOrdersByID', function() {
      it('should call putOrdersByID successfully', function(done) {
        //uncomment below and update the code to test putOrdersByID
        //instance.putOrdersByID(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
