...
(function(root, factory) {
  ...
  describe('StoresApi', function() {
    ...
    describe('getStoresByID', function() {
      it('should call getStoresByID successfully', function(done) {
    ...
    describe('getStoresByIDs', function() {
      it('should call getStoresByIDs successfully', function(done) {
