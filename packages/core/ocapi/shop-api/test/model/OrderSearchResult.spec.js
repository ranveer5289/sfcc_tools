...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new ShopApi.OrderSearchResult();
  });
  ...
  describe('OrderSearchResult', function() {
    it('should create an instance of OrderSearchResult', function() {
      // uncomment below and update the code to test OrderSearchResult
      //var instance = new ShopApi.OrderSearchResult();
      //expect(instance).to.be.a(ShopApi.OrderSearchResult);
    });
