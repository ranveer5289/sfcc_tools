...
(function(root, factory) {
  ...
  describe('OrderSearchRequest', function() {
    it('should create an instance of OrderSearchRequest', function() {
      // uncomment below and update the code to test OrderSearchRequest
      //var instance = new ShopApi.OrderSearchRequest();
