...
(function(root, factory) {
  ...
  describe('PublicProductList', function() {
    it('should create an instance of PublicProductList', function() {
      // uncomment below and update the code to test PublicProductList
      //var instance = new ShopApi.PublicProductList();
