...
(function(root, factory) {
  ...
  describe('CustomerPaymentCardRequest', function() {
    it('should create an instance of CustomerPaymentCardRequest', function() {
      // uncomment below and update the code to test CustomerPaymentCardRequest
      //var instance = new ShopApi.CustomerPaymentCardRequest();
