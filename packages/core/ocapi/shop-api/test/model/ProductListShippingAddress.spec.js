...
(function(root, factory) {
  ...
  describe('ProductListShippingAddress', function() {
    it('should create an instance of ProductListShippingAddress', function() {
      // uncomment below and update the code to test ProductListShippingAddress
      //var instance = new ShopApi.ProductListShippingAddress();
