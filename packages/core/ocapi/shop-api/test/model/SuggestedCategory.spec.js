...
(function(root, factory) {
  ...
  describe('SuggestedCategory', function() {
    it('should create an instance of SuggestedCategory', function() {
      // uncomment below and update the code to test SuggestedCategory
      //var instance = new ShopApi.SuggestedCategory();
