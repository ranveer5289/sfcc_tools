...
(function(root, factory) {
  ...
  describe('SuggestedTerm', function() {
    it('should create an instance of SuggestedTerm', function() {
      // uncomment below and update the code to test SuggestedTerm
      //var instance = new ShopApi.SuggestedTerm();
