...
(function(root, factory) {
  ...
  describe('CustomerAddressLink', function() {
    it('should create an instance of CustomerAddressLink', function() {
      // uncomment below and update the code to test CustomerAddressLink
      //var instance = new ShopApi.CustomerAddressLink();
