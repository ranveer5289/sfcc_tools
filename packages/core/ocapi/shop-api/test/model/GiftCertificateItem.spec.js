...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new ShopApi.GiftCertificateItem();
  });
  ...
  describe('GiftCertificateItem', function() {
    it('should create an instance of GiftCertificateItem', function() {
      // uncomment below and update the code to test GiftCertificateItem
      //var instance = new ShopApi.GiftCertificateItem();
      //expect(instance).to.be.a(ShopApi.GiftCertificateItem);
    });
    ...
    it('should have the property giftCertificateItemId (base name: "gift_certificate_item_id")', function() {
