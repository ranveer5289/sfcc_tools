...
(function(root, factory) {
  ...
  describe('OrderSearchHit', function() {
    it('should create an instance of OrderSearchHit', function() {
      // uncomment below and update the code to test OrderSearchHit
      //var instance = new ShopApi.OrderSearchHit();
