...
(function(root, factory) {
  ...
  describe('ProductSearchRefinement', function() {
    it('should create an instance of ProductSearchRefinement', function() {
      // uncomment below and update the code to test ProductSearchRefinement
      //var instance = new ShopApi.ProductSearchRefinement();
