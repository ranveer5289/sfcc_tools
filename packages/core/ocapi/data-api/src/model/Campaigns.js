...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DataApi.Campaigns = factory(root.DataApi.ApiClient, root.DataApi.Campaign);
  }
  ...
  /**
   * The Campaigns model module.
   * @module model/Campaigns
   * @version 20.8
   */

  /**
   * Constructs a new <code>Campaigns</code>.
   * Document representing an unfiltered list of campaigns.
   * @alias module:model/Campaigns
   * @class
   */
  ...
  /**
   * Constructs a <code>Campaigns</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Campaigns} obj Optional instance to populate.
   * @return {module:model/Campaigns} The populated <code>Campaigns</code> instance.
   */
