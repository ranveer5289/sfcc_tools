...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DataApi.Coupons = factory(root.DataApi.ApiClient, root.DataApi.Coupon);
  }
   ...
   * @param {module:model/Coupons} obj Optional instance to populate.
   * @return {module:model/Coupons} The populated <code>Coupons</code> instance.
   */
