...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InventoryList', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InventoryList'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.InventoryListSearchResult = factory(root.DataApi.ApiClient, root.DataApi.InventoryList, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, InventoryList, ResultPage, Sort) {
  'use strict';



  /**
   * The InventoryListSearchResult model module.
   * @module model/InventoryListSearchResult
   * @version 20.4
   */

  /**
   * Constructs a new <code>InventoryListSearchResult</code>.
   * Document representing a inventorylist search result.
   * @alias module:model/InventoryListSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>InventoryListSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InventoryListSearchResult} obj Optional instance to populate.
   * @return {module:model/InventoryListSearchResult} The populated <code>InventoryListSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [InventoryList]);
      }
   ...
   * @member {Array.<module:model/InventoryList>} hits
   */
