...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ResultPage', 'model/Site', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ResultPage'), require('./Site'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.SiteSearchResult = factory(root.DataApi.ApiClient, root.DataApi.ResultPage, root.DataApi.Site, root.DataApi.Sort);
  }
}(this, function(ApiClient, ResultPage, Site, Sort) {
  'use strict';



  /**
   * The SiteSearchResult model module.
   * @module model/SiteSearchResult
   * @version 20.8
   */

  /**
   * Constructs a new <code>SiteSearchResult</code>.
   * Document representing a site search result.
   * @alias module:model/SiteSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>SiteSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SiteSearchResult} obj Optional instance to populate.
   * @return {module:model/SiteSearchResult} The populated <code>SiteSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [Site]);
      }
   ...
   * @member {Array.<module:model/Site>} hits
   */
