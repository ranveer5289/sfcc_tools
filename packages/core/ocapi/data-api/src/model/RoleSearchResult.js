...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ResultPage', 'model/Role', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ResultPage'), require('./Role'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.RoleSearchResult = factory(root.DataApi.ApiClient, root.DataApi.ResultPage, root.DataApi.Role, root.DataApi.Sort);
  }
}(this, function(ApiClient, ResultPage, Role, Sort) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [Role]);
      }
   ...
   * @member {Array.<module:model/Role>} hits
   */
