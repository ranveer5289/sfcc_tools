...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Coupon', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Coupon'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.CouponSearchResult = factory(root.DataApi.ApiClient, root.DataApi.Coupon, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, Coupon, ResultPage, Sort) {
  'use strict';



  /**
   * The CouponSearchResult model module.
   * @module model/CouponSearchResult
   * @version 20.8
   */

  /**
   * Constructs a new <code>CouponSearchResult</code>.
   * Document representing a coupon search result.
   * @alias module:model/CouponSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>CouponSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CouponSearchResult} obj Optional instance to populate.
   * @return {module:model/CouponSearchResult} The populated <code>CouponSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [Coupon]);
      }
   ...
   * @member {Array.<module:model/Coupon>} hits
   */
