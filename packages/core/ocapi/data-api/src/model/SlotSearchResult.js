...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ResultPage', 'model/Slot', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ResultPage'), require('./Slot'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.SlotSearchResult = factory(root.DataApi.ApiClient, root.DataApi.ResultPage, root.DataApi.Slot, root.DataApi.Sort);
  }
}(this, function(ApiClient, ResultPage, Slot, Sort) {
  'use strict';
   ...
   * @alias module:model/SlotSearchResult
   * @class
   */
   ...
   * @param {module:model/SlotSearchResult} obj Optional instance to populate.
   * @return {module:model/SlotSearchResult} The populated <code>SlotSearchResult</code> instance.
   */
   ...
   * @member {Array.<module:model/Slot>} hits
   */
