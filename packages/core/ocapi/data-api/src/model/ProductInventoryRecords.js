...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ProductInventoryRecord'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ProductInventoryRecord'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.ProductInventoryRecords = factory(root.DataApi.ApiClient, root.DataApi.ProductInventoryRecord);
  }
}(this, function(ApiClient, ProductInventoryRecord) {
  'use strict';
   ...
   * @module model/ProductInventoryRecords
   * @version 20.4
   */
   ...
   * @alias module:model/ProductInventoryRecords
   * @class
   */
   ...
   * @param {module:model/ProductInventoryRecords} obj Optional instance to populate.
   * @return {module:model/ProductInventoryRecords} The populated <code>ProductInventoryRecords</code> instance.
   */
   ...
   * @member {Array.<module:model/ProductInventoryRecord>} data
   */
