...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ResultPage', 'model/Sort', 'model/SourceCodeGroup'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ResultPage'), require('./Sort'), require('./SourceCodeGroup'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.SourceCodeGroupSearchResult = factory(root.DataApi.ApiClient, root.DataApi.ResultPage, root.DataApi.Sort, root.DataApi.SourceCodeGroup);
  }
}(this, function(ApiClient, ResultPage, Sort, SourceCodeGroup) {
  'use strict';



  /**
   * The SourceCodeGroupSearchResult model module.
   * @module model/SourceCodeGroupSearchResult
   * @version 20.8
   */

  /**
   * Constructs a new <code>SourceCodeGroupSearchResult</code>.
   * Document representing a source code group search result.
   * @alias module:model/SourceCodeGroupSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>SourceCodeGroupSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SourceCodeGroupSearchResult} obj Optional instance to populate.
   * @return {module:model/SourceCodeGroupSearchResult} The populated <code>SourceCodeGroupSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [SourceCodeGroup]);
      }
   ...
   * @member {Array.<module:model/SourceCodeGroup>} hits
   */
