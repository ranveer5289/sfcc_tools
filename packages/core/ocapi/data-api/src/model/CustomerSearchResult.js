...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CustomerSearchHit', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CustomerSearchHit'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.CustomerSearchResult = factory(root.DataApi.ApiClient, root.DataApi.CustomerSearchHit, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, CustomerSearchHit, ResultPage, Sort) {
  'use strict';
   ...
   * @member {Array.<module:model/CustomerSearchHit>} hits
   */
