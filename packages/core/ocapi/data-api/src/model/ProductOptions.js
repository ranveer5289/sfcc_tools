...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ProductOption'], factory);
    ...
    root.DataApi.ProductOptions = factory(root.DataApi.ApiClient, root.DataApi.ProductOption);
  }
   ...
   * @alias module:model/ProductOptions
   * @class
   */
   ...
   * @param {module:model/ProductOptions} obj Optional instance to populate.
   * @return {module:model/ProductOptions} The populated <code>ProductOptions</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = ApiClient.convertToType(data['data'], [ProductOption]);
      }
  ...
  /**
   * 
   * @member {Array.<module:model/ProductOption>} data
   */
