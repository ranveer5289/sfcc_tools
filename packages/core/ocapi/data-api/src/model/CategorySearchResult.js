...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Category', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Category'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.CategorySearchResult = factory(root.DataApi.ApiClient, root.DataApi.Category, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, Category, ResultPage, Sort) {
  'use strict';



  /**
   * The CategorySearchResult model module.
   * @module model/CategorySearchResult
   * @version 20.8
   */

  /**
   * Constructs a new <code>CategorySearchResult</code>.
   * Document representing a catalog search result.
   * @alias module:model/CategorySearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>CategorySearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CategorySearchResult} obj Optional instance to populate.
   * @return {module:model/CategorySearchResult} The populated <code>CategorySearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [Category]);
      }
   ...
   * @member {Array.<module:model/Category>} hits
   */
