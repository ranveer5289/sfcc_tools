...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DataApi.ProductOptionValues = factory(root.DataApi.ApiClient, root.DataApi.ProductOptionValue);
  }
  ...
  /**
   * The ProductOptionValues model module.
   * @module model/ProductOptionValues
   * @version 20.4
   */

  /**
   * Constructs a new <code>ProductOptionValues</code>.
   * Document representing an unfiltered list of product option values.
   * @alias module:model/ProductOptionValues
   * @class
   */
  ...
  /**
   * Constructs a <code>ProductOptionValues</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProductOptionValues} obj Optional instance to populate.
   * @return {module:model/ProductOptionValues} The populated <code>ProductOptionValues</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = ApiClient.convertToType(data['data'], [ProductOptionValue]);
      }
  ...
  /**
   * 
   * @member {Array.<module:model/ProductOptionValue>} data
   */
