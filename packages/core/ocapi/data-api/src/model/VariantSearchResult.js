...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ResultPage', 'model/Sort', 'model/Variant'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ResultPage'), require('./Sort'), require('./Variant'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.VariantSearchResult = factory(root.DataApi.ApiClient, root.DataApi.ResultPage, root.DataApi.Sort, root.DataApi.Variant);
  }
}(this, function(ApiClient, ResultPage, Sort, Variant) {
  'use strict';



  /**
   * The VariantSearchResult model module.
   * @module model/VariantSearchResult
   * @version 20.4
   */

  /**
   * Constructs a new <code>VariantSearchResult</code>.
   * Document that represents a search on certificates and keys.
   * @alias module:model/VariantSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>VariantSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VariantSearchResult} obj Optional instance to populate.
   * @return {module:model/VariantSearchResult} The populated <code>VariantSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [Variant]);
      }
   ...
   * @member {Array.<module:model/Variant>} hits
   */
