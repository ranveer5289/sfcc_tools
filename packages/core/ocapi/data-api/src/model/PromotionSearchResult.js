...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Promotion', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Promotion'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.PromotionSearchResult = factory(root.DataApi.ApiClient, root.DataApi.Promotion, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, Promotion, ResultPage, Sort) {
  'use strict';



  /**
   * The PromotionSearchResult model module.
   * @module model/PromotionSearchResult
   * @version 20.8
   */

  /**
   * Constructs a new <code>PromotionSearchResult</code>.
   * Document representing a promotion search result.
   * @alias module:model/PromotionSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>PromotionSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PromotionSearchResult} obj Optional instance to populate.
   * @return {module:model/PromotionSearchResult} The populated <code>PromotionSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [Promotion]);
      }
   ...
   * @member {Array.<module:model/Promotion>} hits
   */
