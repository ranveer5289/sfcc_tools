...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CouponRedemption', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CouponRedemption'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.CouponRedemptionSearchResult = factory(root.DataApi.ApiClient, root.DataApi.CouponRedemption, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, CouponRedemption, ResultPage, Sort) {
  'use strict';



  /**
   * The CouponRedemptionSearchResult model module.
   * @module model/CouponRedemptionSearchResult
   * @version 20.8
   */

  /**
   * Constructs a new <code>CouponRedemptionSearchResult</code>.
   * The result of the coupon redemption search
   * @alias module:model/CouponRedemptionSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>CouponRedemptionSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CouponRedemptionSearchResult} obj Optional instance to populate.
   * @return {module:model/CouponRedemptionSearchResult} The populated <code>CouponRedemptionSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [CouponRedemption]);
      }
  ...
  /**
   * The hits from the search
   * @member {Array.<module:model/CouponRedemption>} hits
   */
