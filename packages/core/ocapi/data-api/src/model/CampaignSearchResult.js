...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Campaign', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Campaign'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.CampaignSearchResult = factory(root.DataApi.ApiClient, root.DataApi.Campaign, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, Campaign, ResultPage, Sort) {
  'use strict';



  /**
   * The CampaignSearchResult model module.
   * @module model/CampaignSearchResult
   * @version 20.8
   */

  /**
   * Constructs a new <code>CampaignSearchResult</code>.
   * Document representing a campaign search result.
   * @alias module:model/CampaignSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>CampaignSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CampaignSearchResult} obj Optional instance to populate.
   * @return {module:model/CampaignSearchResult} The populated <code>CampaignSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [Campaign]);
      }
   ...
   * @member {Array.<module:model/Campaign>} hits
   */
