...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ObjectAttributeDefinition', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ObjectAttributeDefinition'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.ObjectAttributeDefinitionSearchResult = factory(root.DataApi.ApiClient, root.DataApi.ObjectAttributeDefinition, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, ObjectAttributeDefinition, ResultPage, Sort) {
  'use strict';



  /**
   * The ObjectAttributeDefinitionSearchResult model module.
   * @module model/ObjectAttributeDefinitionSearchResult
   * @version 20.4
   */

  /**
   * Constructs a new <code>ObjectAttributeDefinitionSearchResult</code>.
   * Document representing an attributedefinition search result.
   * @alias module:model/ObjectAttributeDefinitionSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>ObjectAttributeDefinitionSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ObjectAttributeDefinitionSearchResult} obj Optional instance to populate.
   * @return {module:model/ObjectAttributeDefinitionSearchResult} The populated <code>ObjectAttributeDefinitionSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [ObjectAttributeDefinition]);
      }
   ...
   * @member {Array.<module:model/ObjectAttributeDefinition>} hits
   */
