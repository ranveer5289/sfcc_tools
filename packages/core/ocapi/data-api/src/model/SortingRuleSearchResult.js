...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ResultPage', 'model/Sort', 'model/SortingRule'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ResultPage'), require('./Sort'), require('./SortingRule'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.SortingRuleSearchResult = factory(root.DataApi.ApiClient, root.DataApi.ResultPage, root.DataApi.Sort, root.DataApi.SortingRule);
  }
}(this, function(ApiClient, ResultPage, Sort, SortingRule) {
  'use strict';



  /**
   * The SortingRuleSearchResult model module.
   * @module model/SortingRuleSearchResult
   * @version 20.8
   */

  /**
   * Constructs a new <code>SortingRuleSearchResult</code>.
   * Document representing a source code group search result.
   * @alias module:model/SortingRuleSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>SortingRuleSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SortingRuleSearchResult} obj Optional instance to populate.
   * @return {module:model/SortingRuleSearchResult} The populated <code>SortingRuleSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [SortingRule]);
      }
   ...
   * @member {Array.<module:model/SortingRule>} hits
   */
