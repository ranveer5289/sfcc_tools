...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ResultPage', 'model/SlotConfigurationCampaignAssignment', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ResultPage'), require('./SlotConfigurationCampaignAssignment'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.SlotConfigurationCampaignAssignmentSearchResult = factory(root.DataApi.ApiClient, root.DataApi.ResultPage, root.DataApi.SlotConfigurationCampaignAssignment, root.DataApi.Sort);
  }
}(this, function(ApiClient, ResultPage, SlotConfigurationCampaignAssignment, Sort) {
  'use strict';



  /**
   * The SlotConfigurationCampaignAssignmentSearchResult model module.
   * @module model/SlotConfigurationCampaignAssignmentSearchResult
   * @version 20.8
   */

  /**
   * Constructs a new <code>SlotConfigurationCampaignAssignmentSearchResult</code>.
   * @alias module:model/SlotConfigurationCampaignAssignmentSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>SlotConfigurationCampaignAssignmentSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SlotConfigurationCampaignAssignmentSearchResult} obj Optional instance to populate.
   * @return {module:model/SlotConfigurationCampaignAssignmentSearchResult} The populated <code>SlotConfigurationCampaignAssignmentSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [SlotConfigurationCampaignAssignment]);
      }
   ...
   * @member {Array.<module:model/SlotConfigurationCampaignAssignment>} hits
   */
