...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CustomerGroupMember', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CustomerGroupMember'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.CustomerGroupMemberSearchResult = factory(root.DataApi.ApiClient, root.DataApi.CustomerGroupMember, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, CustomerGroupMember, ResultPage, Sort) {
  'use strict';



  /**
   * The CustomerGroupMemberSearchResult model module.
   * @module model/CustomerGroupMemberSearchResult
   * @version 20.8
   */

  /**
   * Constructs a new <code>CustomerGroupMemberSearchResult</code>.
   * Document representing a customer group member search result.
   * @alias module:model/CustomerGroupMemberSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>CustomerGroupMemberSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CustomerGroupMemberSearchResult} obj Optional instance to populate.
   * @return {module:model/CustomerGroupMemberSearchResult} The populated <code>CustomerGroupMemberSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [CustomerGroupMember]);
      }
   ...
   * @member {Array.<module:model/CustomerGroupMember>} hits
   */
