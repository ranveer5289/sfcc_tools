...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CustomerGroup', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CustomerGroup'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.CustomerGroupSearchResult = factory(root.DataApi.ApiClient, root.DataApi.CustomerGroup, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, CustomerGroup, ResultPage, Sort) {
  'use strict';



  /**
   * The CustomerGroupSearchResult model module.
   * @module model/CustomerGroupSearchResult
   * @version 20.8
   */

  /**
   * Constructs a new <code>CustomerGroupSearchResult</code>.
   * Document representing a customer group search result.
   * @alias module:model/CustomerGroupSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>CustomerGroupSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CustomerGroupSearchResult} obj Optional instance to populate.
   * @return {module:model/CustomerGroupSearchResult} The populated <code>CustomerGroupSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [CustomerGroup]);
      }
   ...
   * @member {Array.<module:model/CustomerGroup>} hits
   */
