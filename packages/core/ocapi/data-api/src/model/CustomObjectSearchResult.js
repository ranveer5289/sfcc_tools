...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CustomObject', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CustomObject'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.CustomObjectSearchResult = factory(root.DataApi.ApiClient, root.DataApi.CustomObject, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, CustomObject, ResultPage, Sort) {
  'use strict';



  /**
   * The CustomObjectSearchResult model module.
   * @module model/CustomObjectSearchResult
   * @version 20.8
   */

  /**
   * Constructs a new <code>CustomObjectSearchResult</code>.
   * Document representing a custom object search result.
   * @alias module:model/CustomObjectSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>CustomObjectSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CustomObjectSearchResult} obj Optional instance to populate.
   * @return {module:model/CustomObjectSearchResult} The populated <code>CustomObjectSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [CustomObject]);
      }
   ...
   * @member {Array.<module:model/CustomObject>} hits
   */
