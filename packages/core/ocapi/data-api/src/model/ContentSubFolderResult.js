...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DataApi.ContentSubFolderResult = factory(root.DataApi.ApiClient, root.DataApi.ContentFolder);
  }
   ...
   * @module model/ContentSubFolderResult
   * @version 20.8
   */
   ...
   * @alias module:model/ContentSubFolderResult
   * @class
   */
   ...
   * @param {module:model/ContentSubFolderResult} obj Optional instance to populate.
   * @return {module:model/ContentSubFolderResult} The populated <code>ContentSubFolderResult</code> instance.
   */
