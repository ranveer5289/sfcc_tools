...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Variant'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Variant'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.Variants = factory(root.DataApi.ApiClient, root.DataApi.Variant);
  }
}(this, function(ApiClient, Variant) {
  'use strict';
   ...
   * @param {module:model/Variants} obj Optional instance to populate.
   * @return {module:model/Variants} The populated <code>Variants</code> instance.
   */
  ...
  /**
   * 
   * @member {Array.<module:model/Variant>} data
   */
