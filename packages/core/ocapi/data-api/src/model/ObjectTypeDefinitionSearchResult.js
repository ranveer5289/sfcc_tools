...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ObjectTypeDefinition', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ObjectTypeDefinition'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.ObjectTypeDefinitionSearchResult = factory(root.DataApi.ApiClient, root.DataApi.ObjectTypeDefinition, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, ObjectTypeDefinition, ResultPage, Sort) {
  'use strict';



  /**
   * The ObjectTypeDefinitionSearchResult model module.
   * @module model/ObjectTypeDefinitionSearchResult
   * @version 20.4
   */

  /**
   * Constructs a new <code>ObjectTypeDefinitionSearchResult</code>.
   * Document representing a systemobject search result.
   * @alias module:model/ObjectTypeDefinitionSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>ObjectTypeDefinitionSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ObjectTypeDefinitionSearchResult} obj Optional instance to populate.
   * @return {module:model/ObjectTypeDefinitionSearchResult} The populated <code>ObjectTypeDefinitionSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [ObjectTypeDefinition]);
      }
   ...
   * @member {Array.<module:model/ObjectTypeDefinition>} hits
   */
