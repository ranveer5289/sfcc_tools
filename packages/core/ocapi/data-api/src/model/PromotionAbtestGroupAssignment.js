...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DataApi.PromotionAbtestGroupAssignment = factory(root.DataApi.ApiClient, root.DataApi.Schedule);
  }
   ...
   * @module model/PromotionAbtestGroupAssignment
   * @version 20.8
   */

  /**
   * Constructs a new <code>PromotionAbtestGroupAssignment</code>.
   * @alias module:model/PromotionAbtestGroupAssignment
   * @class
   */
   ...
   * @param {module:model/PromotionAbtestGroupAssignment} obj Optional instance to populate.
   * @return {module:model/PromotionAbtestGroupAssignment} The populated <code>PromotionAbtestGroupAssignment</code> instance.
   */
