...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ObjectAttributeGroup', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ObjectAttributeGroup'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.ObjectAttributeGroupSearchResult = factory(root.DataApi.ApiClient, root.DataApi.ObjectAttributeGroup, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, ObjectAttributeGroup, ResultPage, Sort) {
  'use strict';



  /**
   * The ObjectAttributeGroupSearchResult model module.
   * @module model/ObjectAttributeGroupSearchResult
   * @version 20.8
   */

  /**
   * Constructs a new <code>ObjectAttributeGroupSearchResult</code>.
   * Document representing a attributegroup search result.
   * @alias module:model/ObjectAttributeGroupSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>ObjectAttributeGroupSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ObjectAttributeGroupSearchResult} obj Optional instance to populate.
   * @return {module:model/ObjectAttributeGroupSearchResult} The populated <code>ObjectAttributeGroupSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [ObjectAttributeGroup]);
      }
   ...
   * @member {Array.<module:model/ObjectAttributeGroup>} hits
   */
