...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ResultPage', 'model/SlotConfiguration', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ResultPage'), require('./SlotConfiguration'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.SlotConfigurationSearchResult = factory(root.DataApi.ApiClient, root.DataApi.ResultPage, root.DataApi.SlotConfiguration, root.DataApi.Sort);
  }
}(this, function(ApiClient, ResultPage, SlotConfiguration, Sort) {
  'use strict';



  /**
   * The SlotConfigurationSearchResult model module.
   * @module model/SlotConfigurationSearchResult
   * @version 20.8
   */

  /**
   * Constructs a new <code>SlotConfigurationSearchResult</code>.
   * Document representing a slot configuration search result.
   * @alias module:model/SlotConfigurationSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>SlotConfigurationSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SlotConfigurationSearchResult} obj Optional instance to populate.
   * @return {module:model/SlotConfigurationSearchResult} The populated <code>SlotConfigurationSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [SlotConfiguration]);
      }
   ...
   * @member {Array.<module:model/SlotConfiguration>} hits
   */
