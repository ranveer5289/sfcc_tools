...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GiftCertificate', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GiftCertificate'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.GiftCertificateSearchResult = factory(root.DataApi.ApiClient, root.DataApi.GiftCertificate, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, GiftCertificate, ResultPage, Sort) {
  'use strict';



  /**
   * The GiftCertificateSearchResult model module.
   * @module model/GiftCertificateSearchResult
   * @version 20.4
   */

  /**
   * Constructs a new <code>GiftCertificateSearchResult</code>.
   * Document representing a gift certificate search result.
   * @alias module:model/GiftCertificateSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>GiftCertificateSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GiftCertificateSearchResult} obj Optional instance to populate.
   * @return {module:model/GiftCertificateSearchResult} The populated <code>GiftCertificateSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [GiftCertificate]);
      }
   ...
   * @member {Array.<module:model/GiftCertificate>} hits
   */
