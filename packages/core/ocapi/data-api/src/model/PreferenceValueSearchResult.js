...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PreferenceValue', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PreferenceValue'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.PreferenceValueSearchResult = factory(root.DataApi.ApiClient, root.DataApi.PreferenceValue, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, PreferenceValue, ResultPage, Sort) {
  'use strict';



  /**
   * The PreferenceValueSearchResult model module.
   * @module model/PreferenceValueSearchResult
   * @version 20.8
   */

  /**
   * Constructs a new <code>PreferenceValueSearchResult</code>.
   * Document representing a preference value search result.
   * @alias module:model/PreferenceValueSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>PreferenceValueSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PreferenceValueSearchResult} obj Optional instance to populate.
   * @return {module:model/PreferenceValueSearchResult} The populated <code>PreferenceValueSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [PreferenceValue]);
      }
   ...
   * @member {Array.<module:model/PreferenceValue>} hits
   */
