...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ResultPage', 'model/Sort', 'model/Store'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ResultPage'), require('./Sort'), require('./Store'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.StoreSearchResult = factory(root.DataApi.ApiClient, root.DataApi.ResultPage, root.DataApi.Sort, root.DataApi.Store);
  }
}(this, function(ApiClient, ResultPage, Sort, Store) {
  'use strict';



  /**
   * The StoreSearchResult model module.
   * @module model/StoreSearchResult
   * @version 20.8
   */

  /**
   * Constructs a new <code>StoreSearchResult</code>.
   * Document representing a store search result.
   * @alias module:model/StoreSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>StoreSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/StoreSearchResult} obj Optional instance to populate.
   * @return {module:model/StoreSearchResult} The populated <code>StoreSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [Store]);
      }
   ...
   * @member {Array.<module:model/Store>} hits
   */
