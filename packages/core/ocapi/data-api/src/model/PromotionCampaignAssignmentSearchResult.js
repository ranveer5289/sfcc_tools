...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PromotionCampaignAssignment', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PromotionCampaignAssignment'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.PromotionCampaignAssignmentSearchResult = factory(root.DataApi.ApiClient, root.DataApi.PromotionCampaignAssignment, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, PromotionCampaignAssignment, ResultPage, Sort) {
  'use strict';



  /**
   * The PromotionCampaignAssignmentSearchResult model module.
   * @module model/PromotionCampaignAssignmentSearchResult
   * @version 20.8
   */

  /**
   * Constructs a new <code>PromotionCampaignAssignmentSearchResult</code>.
   * Document representing a promotion campaign assignment search result.
   * @alias module:model/PromotionCampaignAssignmentSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>PromotionCampaignAssignmentSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PromotionCampaignAssignmentSearchResult} obj Optional instance to populate.
   * @return {module:model/PromotionCampaignAssignmentSearchResult} The populated <code>PromotionCampaignAssignmentSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [PromotionCampaignAssignment]);
      }
   ...
   * @member {Array.<module:model/PromotionCampaignAssignment>} hits
   */
