...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AbTest', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AbTest'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.AbTestSearchResult = factory(root.DataApi.ApiClient, root.DataApi.AbTest, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, AbTest, ResultPage, Sort) {
  'use strict';
   ...
   * @module model/AbTestSearchResult
   * @version 20.8
   */
   ...
   * @alias module:model/AbTestSearchResult
   * @class
   */
   ...
   * @param {module:model/AbTestSearchResult} obj Optional instance to populate.
   * @return {module:model/AbTestSearchResult} The populated <code>AbTestSearchResult</code> instance.
   */
   ...
   * @member {Array.<module:model/AbTest>} hits
   */
