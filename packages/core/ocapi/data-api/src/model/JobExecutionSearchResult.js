...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/JobExecution', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./JobExecution'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.JobExecutionSearchResult = factory(root.DataApi.ApiClient, root.DataApi.JobExecution, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, JobExecution, ResultPage, Sort) {
  'use strict';
   ...
   * @module model/JobExecutionSearchResult
   * @version 20.8
   */
   ...
   * @alias module:model/JobExecutionSearchResult
   * @class
   */
   ...
   * @param {module:model/JobExecutionSearchResult} obj Optional instance to populate.
   * @return {module:model/JobExecutionSearchResult} The populated <code>JobExecutionSearchResult</code> instance.
   */
   ...
   * @member {Array.<module:model/JobExecution>} hits
   */
