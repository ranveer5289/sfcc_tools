...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CategoryProductAssignment', 'model/ResultPage', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CategoryProductAssignment'), require('./ResultPage'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.DataApi) {
      root.DataApi = {};
    }
    root.DataApi.CategoryProductAssignmentSearchResult = factory(root.DataApi.ApiClient, root.DataApi.CategoryProductAssignment, root.DataApi.ResultPage, root.DataApi.Sort);
  }
}(this, function(ApiClient, CategoryProductAssignment, ResultPage, Sort) {
  'use strict';



  /**
   * The CategoryProductAssignmentSearchResult model module.
   * @module model/CategoryProductAssignmentSearchResult
   * @version 20.8
   */

  /**
   * Constructs a new <code>CategoryProductAssignmentSearchResult</code>.
   * Document representing a product search result.
   * @alias module:model/CategoryProductAssignmentSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>CategoryProductAssignmentSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CategoryProductAssignmentSearchResult} obj Optional instance to populate.
   * @return {module:model/CategoryProductAssignmentSearchResult} The populated <code>CategoryProductAssignmentSearchResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hits')) {
        obj['hits'] = ApiClient.convertToType(data['hits'], [CategoryProductAssignment]);
      }
   ...
   * @member {Array.<module:model/CategoryProductAssignment>} hits
   */
