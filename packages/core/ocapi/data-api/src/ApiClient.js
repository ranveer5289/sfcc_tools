...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DataApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default http://dev14-global-iic.demandware.net/s/-/dw/data/20.4
     */
    this.basePath = 'http://dev14-global-iic.demandware.net/s/-/dw/data/20.4'.replace(/\/+$/, '');
  ...
  /**
    ...
    */
    exports.hostSettings = function() {
        return [
            {
              'url': "//dev14-global-iic.demandware.net/s/-/dw/data/20.4",
