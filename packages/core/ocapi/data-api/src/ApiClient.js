...
(function(root, factory) {
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default http://demo-ocapi.demandware.net/s/-/dw/data/20.4
     */
    this.basePath = 'http://demo-ocapi.demandware.net/s/-/dw/data/20.4'.replace(/\/+$/, '');
  ...
  /**
    ...
    */
    exports.hostSettings = function() {
        return [
            {
              'url': "//demo-ocapi.demandware.net/s/-/dw/data/20.4",
