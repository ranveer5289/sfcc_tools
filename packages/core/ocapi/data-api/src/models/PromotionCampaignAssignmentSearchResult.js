...
* @module models/PromotionCampaignAssignmentSearchResult
* @version 20.8
*/
export default class PromotionCampaignAssignmentSearchResult {
    /**
    ...
    * @alias module:models/PromotionCampaignAssignmentSearchResult
    * @class
    */
    ...
    * @param {module:models/PromotionCampaignAssignmentSearchResult} obj Optional instance to populate.
    * @return {module:models/PromotionCampaignAssignmentSearchResult} The populated <code>PromotionCampaignAssignmentSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionCampaignAssignmentSearchResult();
    ...
    * @member {Array.<module:models/PromotionCampaignAssignment>} hits
    */
    hits = undefined;
    /**
