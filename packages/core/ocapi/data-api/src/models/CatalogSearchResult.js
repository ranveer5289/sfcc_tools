...
* @module models/CatalogSearchResult
* @version 20.8
*/
export default class CatalogSearchResult {
    /**
    * Constructs a new <code>CatalogSearchResult</code>.
    * Document representing a catalog search result.
    * @alias module:models/CatalogSearchResult
    * @class
    */
    ...
    * @param {module:models/CatalogSearchResult} obj Optional instance to populate.
    * @return {module:models/CatalogSearchResult} The populated <code>CatalogSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CatalogSearchResult();
    ...
    * @member {Array.<module:models/Catalog>} hits
    */
    hits = undefined;
    /**
