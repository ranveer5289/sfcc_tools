...
* @module models/VariantSearchResult
* @version 20.8
*/
export default class VariantSearchResult {
    /**
    * Constructs a new <code>VariantSearchResult</code>.
    * Document that represents a search on certificates and keys.
    * @alias module:models/VariantSearchResult
    * @class
    */
    ...
    * @param {module:models/VariantSearchResult} obj Optional instance to populate.
    * @return {module:models/VariantSearchResult} The populated <code>VariantSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VariantSearchResult();
    ...
    * @member {Array.<module:models/Variant>} hits
    */
    hits = undefined;
    /**
