...
* @module models/CategorySearchResult
* @version 20.8
*/
export default class CategorySearchResult {
    /**
    * Constructs a new <code>CategorySearchResult</code>.
    * Document representing a catalog search result.
    * @alias module:models/CategorySearchResult
    * @class
    */
    ...
    * @param {module:models/CategorySearchResult} obj Optional instance to populate.
    * @return {module:models/CategorySearchResult} The populated <code>CategorySearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategorySearchResult();
    ...
    * @member {Array.<module:models/Category>} hits
    */
    hits = undefined;
    /**
