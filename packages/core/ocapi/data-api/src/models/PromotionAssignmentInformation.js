...
* @module models/PromotionAssignmentInformation
* @version 20.8
*/
export default class PromotionAssignmentInformation {
    /**
    * Constructs a new <code>PromotionAssignmentInformation</code>.
    * @alias module:models/PromotionAssignmentInformation
    * @class
    */
    ...
    * @param {module:models/PromotionAssignmentInformation} obj Optional instance to populate.
    * @return {module:models/PromotionAssignmentInformation} The populated <code>PromotionAssignmentInformation</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionAssignmentInformation();
    ...
    * @member {Array.<module:models/PromotionAbtestGroupAssignment>} active_abtest_assignments
    */
    active_abtest_assignments = undefined;
    /**
    * A list of currently active campaigns this is assigned to.
    * @member {Array.<module:models/PromotionCampaignAssignment>} active_campaign_assignments
    */
    ...
    * @member {module:models/PromotionAssignmentInformation.ScheduleTypeEnum} schedule_type
    */
    ...
    * @member {Array.<module:models/PromotionAbtestGroupAssignment>} upcoming_abtest_assignments
    */
    upcoming_abtest_assignments = undefined;
    /**
    * A list of upcoming campaigns this is assigned to.
    * @member {Array.<module:models/PromotionCampaignAssignment>} upcoming_campaign_assignments
    */
