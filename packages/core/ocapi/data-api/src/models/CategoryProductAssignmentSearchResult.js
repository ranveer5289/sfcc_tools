...
* @module models/CategoryProductAssignmentSearchResult
* @version 20.8
*/
export default class CategoryProductAssignmentSearchResult {
    /**
    * Constructs a new <code>CategoryProductAssignmentSearchResult</code>.
    * Document representing a product search result.
    * @alias module:models/CategoryProductAssignmentSearchResult
    * @class
    */
    ...
    * @param {module:models/CategoryProductAssignmentSearchResult} obj Optional instance to populate.
    * @return {module:models/CategoryProductAssignmentSearchResult} The populated <code>CategoryProductAssignmentSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoryProductAssignmentSearchResult();
    ...
    * @member {Array.<module:models/CategoryProductAssignment>} hits
    */
    hits = undefined;
    /**
