...
import CustomerGroupMember from './CustomerGroupMember';
...
* @module models/CustomerGroupMemberSearchResult
* @version 20.8
*/
export default class CustomerGroupMemberSearchResult {
    /**
    * Constructs a new <code>CustomerGroupMemberSearchResult</code>.
    * Document representing a customer group member search result.
    * @alias module:models/CustomerGroupMemberSearchResult
    * @class
    */
    ...
    * @param {module:models/CustomerGroupMemberSearchResult} obj Optional instance to populate.
    * @return {module:models/CustomerGroupMemberSearchResult} The populated <code>CustomerGroupMemberSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomerGroupMemberSearchResult();
    ...
    * @member {Array.<module:models/CustomerGroupMember>} hits
    */
    hits = undefined;
    /**
