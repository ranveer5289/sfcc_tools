...
export default class Sites {
    ...
    * @param {module:models/Sites} obj Optional instance to populate.
    * @return {module:models/Sites} The populated <code>Sites</code> instance.
    */
    ...
    */
    count = undefined;
    /**
    * @member {Array.<module:models/Site>} data
    */
    data = undefined;
    /**
