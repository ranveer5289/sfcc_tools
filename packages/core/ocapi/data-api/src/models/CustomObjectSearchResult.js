...
* @module models/CustomObjectSearchResult
* @version 20.8
*/
export default class CustomObjectSearchResult {
    /**
    * Constructs a new <code>CustomObjectSearchResult</code>.
    * Document representing a custom object search result.
    * @alias module:models/CustomObjectSearchResult
    * @class
    */
    ...
    * @param {module:models/CustomObjectSearchResult} obj Optional instance to populate.
    * @return {module:models/CustomObjectSearchResult} The populated <code>CustomObjectSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomObjectSearchResult();
    ...
    * @member {Array.<module:models/CustomObject>} hits
    */
    hits = undefined;
    /**
