...
export default class CouponCodes {
    ...
    * @alias module:models/CouponCodes
    * @class
    */
    ...
    * @param {module:models/CouponCodes} obj Optional instance to populate.
    * @return {module:models/CouponCodes} The populated <code>CouponCodes</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CouponCodes();
    ...
    * @member {Array.<module:models/CouponCode>} data
    */
    data = undefined;
    /**
