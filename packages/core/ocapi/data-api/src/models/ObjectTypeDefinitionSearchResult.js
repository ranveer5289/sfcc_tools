...
* @module models/ObjectTypeDefinitionSearchResult
* @version 20.8
*/
export default class ObjectTypeDefinitionSearchResult {
    /**
    * Constructs a new <code>ObjectTypeDefinitionSearchResult</code>.
    * Document representing a systemobject search result.
    * @alias module:models/ObjectTypeDefinitionSearchResult
    * @class
    */
    ...
    * @param {module:models/ObjectTypeDefinitionSearchResult} obj Optional instance to populate.
    * @return {module:models/ObjectTypeDefinitionSearchResult} The populated <code>ObjectTypeDefinitionSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ObjectTypeDefinitionSearchResult();
    ...
    * @member {Array.<module:models/ObjectTypeDefinition>} hits
    */
    hits = undefined;
    /**
