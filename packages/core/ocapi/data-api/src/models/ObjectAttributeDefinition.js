...
* @module models/ObjectAttributeDefinition
* @version 20.8
*/
export default class ObjectAttributeDefinition {
    ...
    * @alias module:models/ObjectAttributeDefinition
    * @class
    */
    ...
    * @param {module:models/ObjectAttributeDefinition} obj Optional instance to populate.
    * @return {module:models/ObjectAttributeDefinition} The populated <code>ObjectAttributeDefinition</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ObjectAttributeDefinition();
    ...
    /**
    * @member {module:models/ObjectAttributeValueDefinition} default_value
    */
    ...
    * @member {Array.<module:models/ObjectAttributeValueDefinition>} value_definitions
    */
    value_definitions = undefined;
    /**
    * The type of this attribute.
    * @member {module:models/ObjectAttributeDefinition.ValueTypeEnum} value_type
    */
