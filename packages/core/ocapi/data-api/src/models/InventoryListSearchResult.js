...
* @module models/InventoryListSearchResult
* @version 20.8
*/
export default class InventoryListSearchResult {
    /**
    * Constructs a new <code>InventoryListSearchResult</code>.
    * Document representing a inventorylist search result.
    * @alias module:models/InventoryListSearchResult
    * @class
    */
    ...
    * @param {module:models/InventoryListSearchResult} obj Optional instance to populate.
    * @return {module:models/InventoryListSearchResult} The populated <code>InventoryListSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InventoryListSearchResult();
    ...
    * @member {Array.<module:models/InventoryList>} hits
    */
    hits = undefined;
    /**
