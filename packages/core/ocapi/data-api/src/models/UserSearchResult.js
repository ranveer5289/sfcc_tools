...
* @module models/UserSearchResult
* @version 20.8
*/
export default class UserSearchResult {
    ...
    * @alias module:models/UserSearchResult
    * @class
    */
    ...
    * @param {module:models/UserSearchResult} obj Optional instance to populate.
    * @return {module:models/UserSearchResult} The populated <code>UserSearchResult</code> instance.
    */
    ...
    * @member {Array.<module:models/User>} hits
    */
    hits = undefined;
    /**
