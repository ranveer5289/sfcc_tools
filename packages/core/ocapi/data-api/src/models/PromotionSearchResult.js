...
* @module models/PromotionSearchResult
* @version 20.8
*/
export default class PromotionSearchResult {
    /**
    * Constructs a new <code>PromotionSearchResult</code>.
    * Document representing a promotion search result.
    * @alias module:models/PromotionSearchResult
    * @class
    */
    ...
    * @param {module:models/PromotionSearchResult} obj Optional instance to populate.
    * @return {module:models/PromotionSearchResult} The populated <code>PromotionSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionSearchResult();
    ...
    * @member {Array.<module:models/Promotion>} hits
    */
    hits = undefined;
    /**
