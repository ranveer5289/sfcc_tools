...
* @module models/VariationAttributes
* @version 20.8
*/
export default class VariationAttributes {
    /**
    * Constructs a new <code>VariationAttributes</code>.
    * Document representing an unfiltered list of variation attributes.
    * @alias module:models/VariationAttributes
    * @class
    */
    ...
    * @param {module:models/VariationAttributes} obj Optional instance to populate.
    * @return {module:models/VariationAttributes} The populated <code>VariationAttributes</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VariationAttributes();
    ...
    */
    count = undefined;
    /**
    * @member {Array.<module:models/VariationAttribute>} data
    */
    data = undefined;
    /**
