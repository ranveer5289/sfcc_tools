...
* @module models/SlotConfigurationSearchResult
* @version 20.8
*/
export default class SlotConfigurationSearchResult {
    /**
    * Constructs a new <code>SlotConfigurationSearchResult</code>.
    * Document representing a slot configuration search result.
    * @alias module:models/SlotConfigurationSearchResult
    * @class
    */
    ...
    * @param {module:models/SlotConfigurationSearchResult} obj Optional instance to populate.
    * @return {module:models/SlotConfigurationSearchResult} The populated <code>SlotConfigurationSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SlotConfigurationSearchResult();
    ...
    * @member {Array.<module:models/SlotConfiguration>} hits
    */
    hits = undefined;
    /**
