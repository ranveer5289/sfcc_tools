...
export default class Slots {
    ...
    * @param {module:models/Slots} obj Optional instance to populate.
    * @return {module:models/Slots} The populated <code>Slots</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [Slot]);
            }
    ...
    */
    count = undefined;
    /**
    * @member {Array.<module:models/Slot>} data
    */
    data = undefined;
    /**
