...
export default class CategoryLinks {
    ...
    * @alias module:models/CategoryLinks
    * @class
    */
    ...
    * @param {module:models/CategoryLinks} obj Optional instance to populate.
    * @return {module:models/CategoryLinks} The populated <code>CategoryLinks</code> instance.
    */
    ...
    */
    count = undefined;
    /**
    * @member {Array.<module:models/CategoryLink>} data
    */
    data = undefined;
    /**
