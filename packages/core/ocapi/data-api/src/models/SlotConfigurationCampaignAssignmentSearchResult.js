...
* @module models/SlotConfigurationCampaignAssignmentSearchResult
* @version 20.8
*/
export default class SlotConfigurationCampaignAssignmentSearchResult {
    /**
    * Constructs a new <code>SlotConfigurationCampaignAssignmentSearchResult</code>.
    * @alias module:models/SlotConfigurationCampaignAssignmentSearchResult
    * @class
    */
    ...
    * @param {module:models/SlotConfigurationCampaignAssignmentSearchResult} obj Optional instance to populate.
    * @return {module:models/SlotConfigurationCampaignAssignmentSearchResult} The populated <code>SlotConfigurationCampaignAssignmentSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SlotConfigurationCampaignAssignmentSearchResult();
    ...
    * @member {Array.<module:models/SlotConfigurationCampaignAssignment>} hits
    */
    hits = undefined;
    /**
