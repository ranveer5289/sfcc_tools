...
import SourceCodeGroup from './SourceCodeGroup';

/**
* The SourceCodeGroupSearchResult model module.
* @module models/SourceCodeGroupSearchResult
* @version 20.8
*/
export default class SourceCodeGroupSearchResult {
    /**
    * Constructs a new <code>SourceCodeGroupSearchResult</code>.
    * Document representing a source code group search result.
    * @alias module:models/SourceCodeGroupSearchResult
    * @class
    */
    ...
    * @param {module:models/SourceCodeGroupSearchResult} obj Optional instance to populate.
    * @return {module:models/SourceCodeGroupSearchResult} The populated <code>SourceCodeGroupSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SourceCodeGroupSearchResult();
    ...
    * @member {Array.<module:models/SourceCodeGroup>} hits
    */
    hits = undefined;
    /**
