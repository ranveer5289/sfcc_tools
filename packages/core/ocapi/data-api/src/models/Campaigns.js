...
export default class Campaigns {
    ...
    * @param {module:models/Campaigns} obj Optional instance to populate.
    * @return {module:models/Campaigns} The populated <code>Campaigns</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Campaigns();
    ...
    */
    count = undefined;
    /**
    * @member {Array.<module:models/Campaign>} data
    */
    data = undefined;
    /**
