...
* @module models/CouponSearchResult
* @version 20.8
*/
export default class CouponSearchResult {
    /**
    * Constructs a new <code>CouponSearchResult</code>.
    * Document representing a coupon search result.
    * @alias module:models/CouponSearchResult
    * @class
    */
    ...
    * @param {module:models/CouponSearchResult} obj Optional instance to populate.
    * @return {module:models/CouponSearchResult} The populated <code>CouponSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CouponSearchResult();
    ...
    * @member {Array.<module:models/Coupon>} hits
    */
    hits = undefined;
    /**
