...
* @module models/CampaignSearchResult
* @version 20.8
*/
export default class CampaignSearchResult {
    /**
    * Constructs a new <code>CampaignSearchResult</code>.
    * Document representing a campaign search result.
    * @alias module:models/CampaignSearchResult
    * @class
    */
    ...
    * @param {module:models/CampaignSearchResult} obj Optional instance to populate.
    * @return {module:models/CampaignSearchResult} The populated <code>CampaignSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CampaignSearchResult();
    ...
    * @member {Array.<module:models/Campaign>} hits
    */
    hits = undefined;
    /**
