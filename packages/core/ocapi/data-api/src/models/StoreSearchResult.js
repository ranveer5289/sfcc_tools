...
* @module models/StoreSearchResult
* @version 20.8
*/
export default class StoreSearchResult {
    /**
    * Constructs a new <code>StoreSearchResult</code>.
    * Document representing a store search result.
    * @alias module:models/StoreSearchResult
    * @class
    */
    ...
    * @param {module:models/StoreSearchResult} obj Optional instance to populate.
    * @return {module:models/StoreSearchResult} The populated <code>StoreSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StoreSearchResult();
    ...
    * @member {Array.<module:models/Store>} hits
    */
    hits = undefined;
    /**
