...
* @module models/SortingRuleSearchResult
* @version 20.8
*/
export default class SortingRuleSearchResult {
    /**
    * Constructs a new <code>SortingRuleSearchResult</code>.
    * Document representing a source code group search result.
    * @alias module:models/SortingRuleSearchResult
    * @class
    */
    ...
    * @param {module:models/SortingRuleSearchResult} obj Optional instance to populate.
    * @return {module:models/SortingRuleSearchResult} The populated <code>SortingRuleSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SortingRuleSearchResult();
    ...
    * @member {Array.<module:models/SortingRule>} hits
    */
    hits = undefined;
    /**
