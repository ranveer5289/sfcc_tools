...
* @module models/SiteSearchResult
* @version 20.8
*/
export default class SiteSearchResult {
    ...
    * @alias module:models/SiteSearchResult
    * @class
    */
    ...
    * @param {module:models/SiteSearchResult} obj Optional instance to populate.
    * @return {module:models/SiteSearchResult} The populated <code>SiteSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SiteSearchResult();
    ...
    * @member {Array.<module:models/Site>} hits
    */
    hits = undefined;
    /**
