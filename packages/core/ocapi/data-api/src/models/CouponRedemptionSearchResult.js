...
* @module models/CouponRedemptionSearchResult
* @version 20.8
*/
export default class CouponRedemptionSearchResult {
    /**
    * Constructs a new <code>CouponRedemptionSearchResult</code>.
    * The result of the coupon redemption search
    * @alias module:models/CouponRedemptionSearchResult
    * @class
    */
    ...
    * @param {module:models/CouponRedemptionSearchResult} obj Optional instance to populate.
    * @return {module:models/CouponRedemptionSearchResult} The populated <code>CouponRedemptionSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CouponRedemptionSearchResult();
    ...
    * @member {Array.<module:models/CouponRedemption>} hits
    */
    hits = undefined;
    /**
