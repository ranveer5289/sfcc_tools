...
* @module models/CustomerGroupSearchResult
* @version 20.8
*/
export default class CustomerGroupSearchResult {
    /**
    * Constructs a new <code>CustomerGroupSearchResult</code>.
    * Document representing a customer group search result.
    * @alias module:models/CustomerGroupSearchResult
    * @class
    */
    ...
    * @param {module:models/CustomerGroupSearchResult} obj Optional instance to populate.
    * @return {module:models/CustomerGroupSearchResult} The populated <code>CustomerGroupSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomerGroupSearchResult();
    ...
    * @member {Array.<module:models/CustomerGroup>} hits
    */
    hits = undefined;
    /**
