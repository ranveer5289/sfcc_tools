...
export default class Stores {
    ...
    * @param {module:models/Stores} obj Optional instance to populate.
    * @return {module:models/Stores} The populated <code>Stores</code> instance.
    */
