...
* @module models/PreferenceValueSearchResult
* @version 20.8
*/
export default class PreferenceValueSearchResult {
    /**
    * Constructs a new <code>PreferenceValueSearchResult</code>.
    * Document representing a preference value search result.
    * @alias module:models/PreferenceValueSearchResult
    * @class
    */
    ...
    * @param {module:models/PreferenceValueSearchResult} obj Optional instance to populate.
    * @return {module:models/PreferenceValueSearchResult} The populated <code>PreferenceValueSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PreferenceValueSearchResult();
    ...
    * @member {Array.<module:models/PreferenceValue>} hits
    */
    hits = undefined;
    /**
