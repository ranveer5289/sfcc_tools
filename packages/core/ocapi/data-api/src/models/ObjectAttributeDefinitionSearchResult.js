...
* @module models/ObjectAttributeDefinitionSearchResult
* @version 20.8
*/
export default class ObjectAttributeDefinitionSearchResult {
    /**
    ...
    * @alias module:models/ObjectAttributeDefinitionSearchResult
    * @class
    */
    ...
    * @param {module:models/ObjectAttributeDefinitionSearchResult} obj Optional instance to populate.
    * @return {module:models/ObjectAttributeDefinitionSearchResult} The populated <code>ObjectAttributeDefinitionSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ObjectAttributeDefinitionSearchResult();
    ...
    * @member {Array.<module:models/ObjectAttributeDefinition>} hits
    */
    hits = undefined;
    /**
