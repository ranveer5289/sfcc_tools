...
* @module models/RoleSearchResult
* @version 20.8
*/
export default class RoleSearchResult {
    /**
    * Constructs a new <code>RoleSearchResult</code>.
    * Document representing an access role search result.
    * @alias module:models/RoleSearchResult
    * @class
    */
    ...
    * @param {module:models/RoleSearchResult} obj Optional instance to populate.
    * @return {module:models/RoleSearchResult} The populated <code>RoleSearchResult</code> instance.
    */
    ...
    * @member {Array.<module:models/Role>} hits
    */
    hits = undefined;
    /**
