...
export default class Categories {
    ...
    * @alias module:models/Categories
    * @class
    */
    ...
    * @param {module:models/Categories} obj Optional instance to populate.
    * @return {module:models/Categories} The populated <code>Categories</code> instance.
    */
