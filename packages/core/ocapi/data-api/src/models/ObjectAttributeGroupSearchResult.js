...
* @module models/ObjectAttributeGroupSearchResult
* @version 20.8
*/
export default class ObjectAttributeGroupSearchResult {
    /**
    * Constructs a new <code>ObjectAttributeGroupSearchResult</code>.
    * Document representing a attributegroup search result.
    * @alias module:models/ObjectAttributeGroupSearchResult
    * @class
    */
    ...
    * @param {module:models/ObjectAttributeGroupSearchResult} obj Optional instance to populate.
    * @return {module:models/ObjectAttributeGroupSearchResult} The populated <code>ObjectAttributeGroupSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ObjectAttributeGroupSearchResult();
    ...
    * @member {Array.<module:models/ObjectAttributeGroup>} hits
    */
    hits = undefined;
    /**
