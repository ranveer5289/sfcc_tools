...
export default class ProductOptions {
    ...
    * @alias module:models/ProductOptions
    * @class
    */
    ...
    * @param {module:models/ProductOptions} obj Optional instance to populate.
    * @return {module:models/ProductOptions} The populated <code>ProductOptions</code> instance.
    */
    ...
    */
    count = undefined;
    /**
    * @member {Array.<module:models/ProductOption>} data
    */
    data = undefined;
    /**
