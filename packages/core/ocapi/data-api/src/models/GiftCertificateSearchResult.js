...
* @module models/GiftCertificateSearchResult
* @version 20.8
*/
export default class GiftCertificateSearchResult {
    /**
    * Constructs a new <code>GiftCertificateSearchResult</code>.
    * Document representing a gift certificate search result.
    * @alias module:models/GiftCertificateSearchResult
    * @class
    */
    ...
    * @param {module:models/GiftCertificateSearchResult} obj Optional instance to populate.
    * @return {module:models/GiftCertificateSearchResult} The populated <code>GiftCertificateSearchResult</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GiftCertificateSearchResult();
    ...
    * @member {Array.<module:models/GiftCertificate>} hits
    */
    hits = undefined;
    /**
