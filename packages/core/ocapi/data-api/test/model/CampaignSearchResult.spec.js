...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.CampaignSearchResult();
  });
  ...
  describe('CampaignSearchResult', function() {
    it('should create an instance of CampaignSearchResult', function() {
      // uncomment below and update the code to test CampaignSearchResult
      //var instance = new DataApi.CampaignSearchResult();
      //expect(instance).to.be.a(DataApi.CampaignSearchResult);
    });
