...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.CategoryProductAssignmentSearchRequest();
  });
  ...
  describe('CategoryProductAssignmentSearchRequest', function() {
    it('should create an instance of CategoryProductAssignmentSearchRequest', function() {
      // uncomment below and update the code to test CategoryProductAssignmentSearchRequest
      //var instance = new DataApi.CategoryProductAssignmentSearchRequest();
      //expect(instance).to.be.a(DataApi.CategoryProductAssignmentSearchRequest);
    });
