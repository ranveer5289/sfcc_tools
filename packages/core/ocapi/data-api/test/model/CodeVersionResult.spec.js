...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.CodeVersionResult();
  });
  ...
  describe('CodeVersionResult', function() {
    it('should create an instance of CodeVersionResult', function() {
      // uncomment below and update the code to test CodeVersionResult
      //var instance = new DataApi.CodeVersionResult();
      //expect(instance).to.be.a(DataApi.CodeVersionResult);
    });
