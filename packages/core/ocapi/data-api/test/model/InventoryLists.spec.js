...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.InventoryLists();
  });
  ...
  describe('InventoryLists', function() {
    it('should create an instance of InventoryLists', function() {
      // uncomment below and update the code to test InventoryLists
      //var instance = new DataApi.InventoryLists();
      //expect(instance).to.be.a(DataApi.InventoryLists);
    });
