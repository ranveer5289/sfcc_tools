...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.ContentFolderResult();
  });
  ...
  describe('ContentFolderResult', function() {
    it('should create an instance of ContentFolderResult', function() {
      // uncomment below and update the code to test ContentFolderResult
      //var instance = new DataApi.ContentFolderResult();
      //expect(instance).to.be.a(DataApi.ContentFolderResult);
    });
