...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.CustomerGroups();
  });
  ...
  describe('CustomerGroups', function() {
    it('should create an instance of CustomerGroups', function() {
      // uncomment below and update the code to test CustomerGroups
      //var instance = new DataApi.CustomerGroups();
      //expect(instance).to.be.a(DataApi.CustomerGroups);
    });
