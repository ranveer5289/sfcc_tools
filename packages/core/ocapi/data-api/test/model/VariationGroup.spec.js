...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.VariationGroup();
  });
  ...
  describe('VariationGroup', function() {
    it('should create an instance of VariationGroup', function() {
      // uncomment below and update the code to test VariationGroup
      //var instance = new DataApi.VariationGroup();
      //expect(instance).to.be.a(DataApi.VariationGroup);
    });
