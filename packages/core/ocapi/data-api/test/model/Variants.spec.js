...
(function(root, factory) {
  ...
  describe('Variants', function() {
    it('should create an instance of Variants', function() {
      // uncomment below and update the code to test Variants
      //var instance = new DataApi.Variants();
      //expect(instance).to.be.a(DataApi.Variants);
    });
