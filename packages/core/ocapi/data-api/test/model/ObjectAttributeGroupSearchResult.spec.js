...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.ObjectAttributeGroupSearchResult();
  });
  ...
  describe('ObjectAttributeGroupSearchResult', function() {
    it('should create an instance of ObjectAttributeGroupSearchResult', function() {
      // uncomment below and update the code to test ObjectAttributeGroupSearchResult
      //var instance = new DataApi.ObjectAttributeGroupSearchResult();
      //expect(instance).to.be.a(DataApi.ObjectAttributeGroupSearchResult);
    });
