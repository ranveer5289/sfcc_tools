...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.ObjectAttributeDefinitions();
  });
  ...
  describe('ObjectAttributeDefinitions', function() {
    it('should create an instance of ObjectAttributeDefinitions', function() {
      // uncomment below and update the code to test ObjectAttributeDefinitions
      //var instance = new DataApi.ObjectAttributeDefinitions();
      //expect(instance).to.be.a(DataApi.ObjectAttributeDefinitions);
    });
