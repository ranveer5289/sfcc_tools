...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.SlotConfigurations();
  });
  ...
  describe('SlotConfigurations', function() {
    it('should create an instance of SlotConfigurations', function() {
      // uncomment below and update the code to test SlotConfigurations
      //var instance = new DataApi.SlotConfigurations();
      //expect(instance).to.be.a(DataApi.SlotConfigurations);
    });
