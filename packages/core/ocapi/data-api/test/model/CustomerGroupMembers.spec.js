...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.CustomerGroupMembers();
  });
  ...
  describe('CustomerGroupMembers', function() {
    it('should create an instance of CustomerGroupMembers', function() {
      // uncomment below and update the code to test CustomerGroupMembers
      //var instance = new DataApi.CustomerGroupMembers();
      //expect(instance).to.be.a(DataApi.CustomerGroupMembers);
    });
