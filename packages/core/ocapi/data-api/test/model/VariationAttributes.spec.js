...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.VariationAttributes();
  });
  ...
  describe('VariationAttributes', function() {
    it('should create an instance of VariationAttributes', function() {
      // uncomment below and update the code to test VariationAttributes
      //var instance = new DataApi.VariationAttributes();
      //expect(instance).to.be.a(DataApi.VariationAttributes);
    });
