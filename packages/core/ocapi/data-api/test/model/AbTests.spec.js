...
(function(root, factory) {
  ...
  describe('AbTests', function() {
    it('should create an instance of AbTests', function() {
      // uncomment below and update the code to test AbTests
      //var instance = new DataApi.AbTests();
      //expect(instance).to.be.a(DataApi.AbTests);
    });
