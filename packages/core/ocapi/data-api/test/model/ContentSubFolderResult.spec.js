...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.ContentSubFolderResult();
  });
  ...
  describe('ContentSubFolderResult', function() {
    it('should create an instance of ContentSubFolderResult', function() {
      // uncomment below and update the code to test ContentSubFolderResult
      //var instance = new DataApi.ContentSubFolderResult();
      //expect(instance).to.be.a(DataApi.ContentSubFolderResult);
    });
