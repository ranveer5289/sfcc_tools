...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.VariantSearchResult();
  });
  ...
  describe('VariantSearchResult', function() {
    it('should create an instance of VariantSearchResult', function() {
      // uncomment below and update the code to test VariantSearchResult
      //var instance = new DataApi.VariantSearchResult();
      //expect(instance).to.be.a(DataApi.VariantSearchResult);
    });
