...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.CustomerAddressResult();
  });
  ...
  describe('CustomerAddressResult', function() {
    it('should create an instance of CustomerAddressResult', function() {
      // uncomment below and update the code to test CustomerAddressResult
      //var instance = new DataApi.CustomerAddressResult();
      //expect(instance).to.be.a(DataApi.CustomerAddressResult);
    });
