...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.ProductInventoryRecords();
  });
  ...
  describe('ProductInventoryRecords', function() {
    it('should create an instance of ProductInventoryRecords', function() {
      // uncomment below and update the code to test ProductInventoryRecords
      //var instance = new DataApi.ProductInventoryRecords();
      //expect(instance).to.be.a(DataApi.ProductInventoryRecords);
    });
