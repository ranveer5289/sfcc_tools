...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.StoreSearchResult();
  });
  ...
  describe('StoreSearchResult', function() {
    it('should create an instance of StoreSearchResult', function() {
      // uncomment below and update the code to test StoreSearchResult
      //var instance = new DataApi.StoreSearchResult();
      //expect(instance).to.be.a(DataApi.StoreSearchResult);
    });
