...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.CategoryProductAssignmentSearchResult();
  });
  ...
  describe('CategoryProductAssignmentSearchResult', function() {
    it('should create an instance of CategoryProductAssignmentSearchResult', function() {
      // uncomment below and update the code to test CategoryProductAssignmentSearchResult
      //var instance = new DataApi.CategoryProductAssignmentSearchResult();
      //expect(instance).to.be.a(DataApi.CategoryProductAssignmentSearchResult);
    });
