...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.VariationAttributeValues();
  });
  ...
  describe('VariationAttributeValues', function() {
    it('should create an instance of VariationAttributeValues', function() {
      // uncomment below and update the code to test VariationAttributeValues
      //var instance = new DataApi.VariationAttributeValues();
      //expect(instance).to.be.a(DataApi.VariationAttributeValues);
    });
