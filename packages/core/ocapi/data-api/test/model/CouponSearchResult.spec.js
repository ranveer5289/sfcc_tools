...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.CouponSearchResult();
  });
  ...
  describe('CouponSearchResult', function() {
    it('should create an instance of CouponSearchResult', function() {
      // uncomment below and update the code to test CouponSearchResult
      //var instance = new DataApi.CouponSearchResult();
      //expect(instance).to.be.a(DataApi.CouponSearchResult);
    });
