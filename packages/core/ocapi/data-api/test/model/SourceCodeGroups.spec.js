...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.SourceCodeGroups();
  });
  ...
  describe('SourceCodeGroups', function() {
    it('should create an instance of SourceCodeGroups', function() {
      // uncomment below and update the code to test SourceCodeGroups
      //var instance = new DataApi.SourceCodeGroups();
      //expect(instance).to.be.a(DataApi.SourceCodeGroups);
    });
