...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.AbTestSearchResult();
  });
  ...
  describe('AbTestSearchResult', function() {
    it('should create an instance of AbTestSearchResult', function() {
      // uncomment below and update the code to test AbTestSearchResult
      //var instance = new DataApi.AbTestSearchResult();
      //expect(instance).to.be.a(DataApi.AbTestSearchResult);
    });
