...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.CustomerSearchResult();
  });
  ...
  describe('CustomerSearchResult', function() {
    it('should create an instance of CustomerSearchResult', function() {
      // uncomment below and update the code to test CustomerSearchResult
      //var instance = new DataApi.CustomerSearchResult();
      //expect(instance).to.be.a(DataApi.CustomerSearchResult);
    });
