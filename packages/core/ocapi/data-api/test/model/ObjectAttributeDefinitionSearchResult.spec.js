...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.ObjectAttributeDefinitionSearchResult();
  });
  ...
  describe('ObjectAttributeDefinitionSearchResult', function() {
    it('should create an instance of ObjectAttributeDefinitionSearchResult', function() {
      // uncomment below and update the code to test ObjectAttributeDefinitionSearchResult
      //var instance = new DataApi.ObjectAttributeDefinitionSearchResult();
      //expect(instance).to.be.a(DataApi.ObjectAttributeDefinitionSearchResult);
    });
