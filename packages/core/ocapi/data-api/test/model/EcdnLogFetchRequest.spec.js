...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.EcdnLogFetchRequest();
  });
  ...
  describe('EcdnLogFetchRequest', function() {
    it('should create an instance of EcdnLogFetchRequest', function() {
      // uncomment below and update the code to test EcdnLogFetchRequest
      //var instance = new DataApi.EcdnLogFetchRequest();
      //expect(instance).to.be.a(DataApi.EcdnLogFetchRequest);
    });
