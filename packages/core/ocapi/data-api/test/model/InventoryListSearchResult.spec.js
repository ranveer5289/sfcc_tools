...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.InventoryListSearchResult();
  });
  ...
  describe('InventoryListSearchResult', function() {
    it('should create an instance of InventoryListSearchResult', function() {
      // uncomment below and update the code to test InventoryListSearchResult
      //var instance = new DataApi.InventoryListSearchResult();
      //expect(instance).to.be.a(DataApi.InventoryListSearchResult);
    });
