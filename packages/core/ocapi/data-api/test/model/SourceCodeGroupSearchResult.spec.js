...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.SourceCodeGroupSearchResult();
  });
  ...
  describe('SourceCodeGroupSearchResult', function() {
    it('should create an instance of SourceCodeGroupSearchResult', function() {
      // uncomment below and update the code to test SourceCodeGroupSearchResult
      //var instance = new DataApi.SourceCodeGroupSearchResult();
      //expect(instance).to.be.a(DataApi.SourceCodeGroupSearchResult);
    });
