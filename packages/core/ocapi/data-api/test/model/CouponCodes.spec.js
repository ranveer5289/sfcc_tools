...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.CouponCodes();
  });
  ...
  describe('CouponCodes', function() {
    it('should create an instance of CouponCodes', function() {
      // uncomment below and update the code to test CouponCodes
      //var instance = new DataApi.CouponCodes();
      //expect(instance).to.be.a(DataApi.CouponCodes);
    });
