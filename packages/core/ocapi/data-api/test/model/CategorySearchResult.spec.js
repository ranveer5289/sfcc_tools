...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.CategorySearchResult();
  });
  ...
  describe('CategorySearchResult', function() {
    it('should create an instance of CategorySearchResult', function() {
      // uncomment below and update the code to test CategorySearchResult
      //var instance = new DataApi.CategorySearchResult();
      //expect(instance).to.be.a(DataApi.CategorySearchResult);
    });
