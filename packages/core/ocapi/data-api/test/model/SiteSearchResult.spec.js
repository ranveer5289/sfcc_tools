...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.SiteSearchResult();
  });
  ...
  describe('SiteSearchResult', function() {
    it('should create an instance of SiteSearchResult', function() {
      // uncomment below and update the code to test SiteSearchResult
      //var instance = new DataApi.SiteSearchResult();
      //expect(instance).to.be.a(DataApi.SiteSearchResult);
    });
