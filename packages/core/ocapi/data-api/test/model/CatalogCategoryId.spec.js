...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.CatalogCategoryId();
  });
  ...
  describe('CatalogCategoryId', function() {
    it('should create an instance of CatalogCategoryId', function() {
      // uncomment below and update the code to test CatalogCategoryId
      //var instance = new DataApi.CatalogCategoryId();
      //expect(instance).to.be.a(DataApi.CatalogCategoryId);
    });
