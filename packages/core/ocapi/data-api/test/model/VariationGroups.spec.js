...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.VariationGroups();
  });
  ...
  describe('VariationGroups', function() {
    it('should create an instance of VariationGroups', function() {
      // uncomment below and update the code to test VariationGroups
      //var instance = new DataApi.VariationGroups();
      //expect(instance).to.be.a(DataApi.VariationGroups);
    });
