...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.CouponRedemptionSearchResult();
  });
  ...
  describe('CouponRedemptionSearchResult', function() {
    it('should create an instance of CouponRedemptionSearchResult', function() {
      // uncomment below and update the code to test CouponRedemptionSearchResult
      //var instance = new DataApi.CouponRedemptionSearchResult();
      //expect(instance).to.be.a(DataApi.CouponRedemptionSearchResult);
    });
