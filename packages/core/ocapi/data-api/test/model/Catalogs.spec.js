...
(function(root, factory) {
  ...
  describe('Catalogs', function() {
    it('should create an instance of Catalogs', function() {
      // uncomment below and update the code to test Catalogs
      //var instance = new DataApi.Catalogs();
      //expect(instance).to.be.a(DataApi.Catalogs);
    });
