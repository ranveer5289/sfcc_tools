...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.ProductOptions();
  });
  ...
  describe('ProductOptions', function() {
    it('should create an instance of ProductOptions', function() {
      // uncomment below and update the code to test ProductOptions
      //var instance = new DataApi.ProductOptions();
      //expect(instance).to.be.a(DataApi.ProductOptions);
    });
