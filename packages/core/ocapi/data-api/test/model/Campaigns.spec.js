...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.Campaigns();
  });
  ...
  describe('Campaigns', function() {
    it('should create an instance of Campaigns', function() {
      // uncomment below and update the code to test Campaigns
      //var instance = new DataApi.Campaigns();
      //expect(instance).to.be.a(DataApi.Campaigns);
    });
