...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.CatalogSearchResult();
  });
  ...
  describe('CatalogSearchResult', function() {
    it('should create an instance of CatalogSearchResult', function() {
      // uncomment below and update the code to test CatalogSearchResult
      //var instance = new DataApi.CatalogSearchResult();
      //expect(instance).to.be.a(DataApi.CatalogSearchResult);
    });
