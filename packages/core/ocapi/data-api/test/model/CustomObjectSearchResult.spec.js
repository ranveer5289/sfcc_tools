...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.CustomObjectSearchResult();
  });
  ...
  describe('CustomObjectSearchResult', function() {
    it('should create an instance of CustomObjectSearchResult', function() {
      // uncomment below and update the code to test CustomObjectSearchResult
      //var instance = new DataApi.CustomObjectSearchResult();
      //expect(instance).to.be.a(DataApi.CustomObjectSearchResult);
    });
