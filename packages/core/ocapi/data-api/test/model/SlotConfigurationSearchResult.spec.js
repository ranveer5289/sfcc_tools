...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.SlotConfigurationSearchResult();
  });
  ...
  describe('SlotConfigurationSearchResult', function() {
    it('should create an instance of SlotConfigurationSearchResult', function() {
      // uncomment below and update the code to test SlotConfigurationSearchResult
      //var instance = new DataApi.SlotConfigurationSearchResult();
      //expect(instance).to.be.a(DataApi.SlotConfigurationSearchResult);
    });
