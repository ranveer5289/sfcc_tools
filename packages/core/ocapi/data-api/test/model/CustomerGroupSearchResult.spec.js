...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.CustomerGroupSearchResult();
  });
  ...
  describe('CustomerGroupSearchResult', function() {
    it('should create an instance of CustomerGroupSearchResult', function() {
      // uncomment below and update the code to test CustomerGroupSearchResult
      //var instance = new DataApi.CustomerGroupSearchResult();
      //expect(instance).to.be.a(DataApi.CustomerGroupSearchResult);
    });
