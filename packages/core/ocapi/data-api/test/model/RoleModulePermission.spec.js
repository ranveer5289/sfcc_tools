...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.RoleModulePermission();
  });
  ...
  describe('RoleModulePermission', function() {
    it('should create an instance of RoleModulePermission', function() {
      // uncomment below and update the code to test RoleModulePermission
      //var instance = new DataApi.RoleModulePermission();
      //expect(instance).to.be.a(DataApi.RoleModulePermission);
    });
