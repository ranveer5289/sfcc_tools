...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.PreferenceValueSearchResult();
  });
  ...
  describe('PreferenceValueSearchResult', function() {
    it('should create an instance of PreferenceValueSearchResult', function() {
      // uncomment below and update the code to test PreferenceValueSearchResult
      //var instance = new DataApi.PreferenceValueSearchResult();
      //expect(instance).to.be.a(DataApi.PreferenceValueSearchResult);
    });
