...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.SlotSearchResult();
  });
  ...
  describe('SlotSearchResult', function() {
    it('should create an instance of SlotSearchResult', function() {
      // uncomment below and update the code to test SlotSearchResult
      //var instance = new DataApi.SlotSearchResult();
      //expect(instance).to.be.a(DataApi.SlotSearchResult);
    });
