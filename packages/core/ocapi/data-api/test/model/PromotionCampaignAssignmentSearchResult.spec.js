...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.PromotionCampaignAssignmentSearchResult();
  });
  ...
  describe('PromotionCampaignAssignmentSearchResult', function() {
    it('should create an instance of PromotionCampaignAssignmentSearchResult', function() {
      // uncomment below and update the code to test PromotionCampaignAssignmentSearchResult
      //var instance = new DataApi.PromotionCampaignAssignmentSearchResult();
      //expect(instance).to.be.a(DataApi.PromotionCampaignAssignmentSearchResult);
    });
