...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.CustomerGroupMemberSearchResult();
  });
  ...
  describe('CustomerGroupMemberSearchResult', function() {
    it('should create an instance of CustomerGroupMemberSearchResult', function() {
      // uncomment below and update the code to test CustomerGroupMemberSearchResult
      //var instance = new DataApi.CustomerGroupMemberSearchResult();
      //expect(instance).to.be.a(DataApi.CustomerGroupMemberSearchResult);
    });
