...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.ProductOptionValues();
  });
  ...
  describe('ProductOptionValues', function() {
    it('should create an instance of ProductOptionValues', function() {
      // uncomment below and update the code to test ProductOptionValues
      //var instance = new DataApi.ProductOptionValues();
      //expect(instance).to.be.a(DataApi.ProductOptionValues);
    });
