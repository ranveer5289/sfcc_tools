...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.ObjectTypeDefinitionSearchResult();
  });
  ...
  describe('ObjectTypeDefinitionSearchResult', function() {
    it('should create an instance of ObjectTypeDefinitionSearchResult', function() {
      // uncomment below and update the code to test ObjectTypeDefinitionSearchResult
      //var instance = new DataApi.ObjectTypeDefinitionSearchResult();
      //expect(instance).to.be.a(DataApi.ObjectTypeDefinitionSearchResult);
    });
