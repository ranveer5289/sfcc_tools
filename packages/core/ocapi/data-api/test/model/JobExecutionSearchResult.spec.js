...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.JobExecutionSearchResult();
  });
  ...
  describe('JobExecutionSearchResult', function() {
    it('should create an instance of JobExecutionSearchResult', function() {
      // uncomment below and update the code to test JobExecutionSearchResult
      //var instance = new DataApi.JobExecutionSearchResult();
      //expect(instance).to.be.a(DataApi.JobExecutionSearchResult);
    });
