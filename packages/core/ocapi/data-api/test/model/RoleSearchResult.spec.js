...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.RoleSearchResult();
  });
  ...
  describe('RoleSearchResult', function() {
    it('should create an instance of RoleSearchResult', function() {
      // uncomment below and update the code to test RoleSearchResult
      //var instance = new DataApi.RoleSearchResult();
      //expect(instance).to.be.a(DataApi.RoleSearchResult);
    });
