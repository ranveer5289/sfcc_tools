...
(function(root, factory) {
  ...
  describe('Coupons', function() {
    it('should create an instance of Coupons', function() {
      // uncomment below and update the code to test Coupons
      //var instance = new DataApi.Coupons();
      //expect(instance).to.be.a(DataApi.Coupons);
    });
