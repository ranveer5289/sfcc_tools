...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.PromotionSearchResult();
  });
  ...
  describe('PromotionSearchResult', function() {
    it('should create an instance of PromotionSearchResult', function() {
      // uncomment below and update the code to test PromotionSearchResult
      //var instance = new DataApi.PromotionSearchResult();
      //expect(instance).to.be.a(DataApi.PromotionSearchResult);
    });
