...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.TermQuery();
  });
  ...
  describe('TermQuery', function() {
    it('should create an instance of TermQuery', function() {
      // uncomment below and update the code to test TermQuery
      //var instance = new DataApi.TermQuery();
      //expect(instance).to.be.a(DataApi.TermQuery);
    });
