...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.LocaleResult();
  });
  ...
  describe('LocaleResult', function() {
    it('should create an instance of LocaleResult', function() {
      // uncomment below and update the code to test LocaleResult
      //var instance = new DataApi.LocaleResult();
      //expect(instance).to.be.a(DataApi.LocaleResult);
    });
    ...
    it('should have the property includeAll (base name: "include_all")', function() {
