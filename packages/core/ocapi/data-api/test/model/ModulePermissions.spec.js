...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.ModulePermissions();
  });
  ...
  describe('ModulePermissions', function() {
    it('should create an instance of ModulePermissions', function() {
      // uncomment below and update the code to test ModulePermissions
      //var instance = new DataApi.ModulePermissions();
      //expect(instance).to.be.a(DataApi.ModulePermissions);
    });
