...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.GiftCertificates();
  });
  ...
  describe('GiftCertificates', function() {
    it('should create an instance of GiftCertificates', function() {
      // uncomment below and update the code to test GiftCertificates
      //var instance = new DataApi.GiftCertificates();
      //expect(instance).to.be.a(DataApi.GiftCertificates);
    });
