...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.SlotConfigurationCampaignAssignmentSearchResult();
  });
  ...
  describe('SlotConfigurationCampaignAssignmentSearchResult', function() {
    it('should create an instance of SlotConfigurationCampaignAssignmentSearchResult', function() {
      // uncomment below and update the code to test SlotConfigurationCampaignAssignmentSearchResult
      //var instance = new DataApi.SlotConfigurationCampaignAssignmentSearchResult();
      //expect(instance).to.be.a(DataApi.SlotConfigurationCampaignAssignmentSearchResult);
    });
