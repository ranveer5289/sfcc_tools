...
(function(root, factory) {
  ...
  describe('Slots', function() {
    it('should create an instance of Slots', function() {
      // uncomment below and update the code to test Slots
      //var instance = new DataApi.Slots();
      //expect(instance).to.be.a(DataApi.Slots);
    });
