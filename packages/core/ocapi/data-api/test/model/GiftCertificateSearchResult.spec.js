...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.GiftCertificateSearchResult();
  });
  ...
  describe('GiftCertificateSearchResult', function() {
    it('should create an instance of GiftCertificateSearchResult', function() {
      // uncomment below and update the code to test GiftCertificateSearchResult
      //var instance = new DataApi.GiftCertificateSearchResult();
      //expect(instance).to.be.a(DataApi.GiftCertificateSearchResult);
    });
