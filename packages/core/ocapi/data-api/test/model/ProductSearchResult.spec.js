...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.ProductSearchResult();
  });
  ...
  describe('ProductSearchResult', function() {
    it('should create an instance of ProductSearchResult', function() {
      // uncomment below and update the code to test ProductSearchResult
      //var instance = new DataApi.ProductSearchResult();
      //expect(instance).to.be.a(DataApi.ProductSearchResult);
    });
