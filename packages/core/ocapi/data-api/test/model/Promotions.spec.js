...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new DataApi.Promotions();
  });
  ...
  describe('Promotions', function() {
    it('should create an instance of Promotions', function() {
      // uncomment below and update the code to test Promotions
      //var instance = new DataApi.Promotions();
      //expect(instance).to.be.a(DataApi.Promotions);
    });
