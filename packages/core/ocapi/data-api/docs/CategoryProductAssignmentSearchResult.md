# DataApi.CategoryProductAssignmentSearchResult
...
**hits** | [**[CategoryProductAssignment]**](CategoryProductAssignment.md) | The sorted array of search hits. This array can be empty. | [optional] 
